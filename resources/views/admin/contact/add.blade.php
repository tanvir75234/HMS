          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" id="" name="contact_name">
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="col-sm-3 col-form-label col_form_label mb-5">Email :</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" id="" name="contact_email">
                  </div>
                  <div class="row mb-3">
                  <label class="col-sm-3 col-form-label col_form_label mb-5">Phone :</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" id="" name="contact_phone">
                  </div>
                  <div class="row mb-3">
                  <label class="col-sm-3 col-form-label col_form_label mb-5">Subject :</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" id="" name="contact_subject">
                  </div>
                   <div class="row mb-3">
                  <label class="col-sm-3 col-form-label col_form_label mb-5">Message :</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" id="" name="contact_message">
                  </div>
