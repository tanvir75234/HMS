          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control form_control" id="" name="paid_amount" value="{{$data->paid_amount}}">
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="col-sm-3 col-form-label col_form_label">Due Amount <span class="req_star">*</span>:</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control form_control" id="" name="due_amount"  value="{{$data->due_amount}}">
                  </div>
                </div>
                <div class="row mb-3">
