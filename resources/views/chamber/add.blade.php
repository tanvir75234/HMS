...
@section('content')
  <div class="row">
    <div class="col-md-12 ">
      <form method="post" action="{{ route('chamber.submit') }}">
        @csrf
          <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" id="" name="chamber_name">
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="col-sm-3 col-form-label col_form_label">Address:</label>
                  <div class="col-sm-7">
                    <textarea type="text" class="form-control form_control" id="" name="chamber_address"></textarea>
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="col-sm-3 col-form-label col_form_label">Author<span class="req_star">*</span>:</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" id="" name="chamber_author">
                  </div>
                </div>
            </div>
